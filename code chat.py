...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "5955948948:AAH3lweYpTsp1IS7TRC0WPSkU3SI-yGNwmY"
else:
    tgkey = tgenv
print(tgenv)
...
qcache = None
chat_log = None
botname = 'Chat Gpt Bot_1'
username = 'openChat_gpt_bot'
